...
namespace MSWD.Controllers
{
    public class SeniorCitizensController : Controller
    {
        ...
        {
            var seniorCitizens = db.SeniorCitizens.Include(s => s.Client);
        ...
        {
            ViewBag.SeniorCitizenId = new SelectList(db.Clients, "ClientId", "GivenName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "SeniorCitizenId,ClientId")] SeniorCitizen seniorCitizen)
        {
            ...
            ViewBag.SeniorCitizenId = new SelectList(db.Clients, "ClientId", "GivenName", seniorCitizen.SeniorCitizenId);
            return View(seniorCitizen);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SeniorCitizenId,ClientId")] SeniorCitizen seniorCitizen)
        {
            if (ModelState.IsValid)
            {
